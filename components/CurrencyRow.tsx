...
const FLAG_OVERRIDES: Record<string, string> = {
  EUR: 'eu', GBP: 'gb', USD: 'us', ANG: 'an', XCD: 'ag',
  XOF: 'sn', XAF: 'cm', XPF: 'pf', AUD: 'au', NZD: 'nz',
  ZAR: 'za', ILS: 'il', JPY: 'jp', KRW: 'kr', CHF: 'ch',
  CNY: 'cn', KGS: 'kg', KZT: 'kz', UZS: 'uz', UAH: 'ua',
  RUB: 'ru', BYN: 'by', AMD: 'am', GEL: 'ge', AZN: 'az', TRY: 'tr',
};
...
const CurrencyRow = memo(function CurrencyRow({
  label, amount, currency, currencies,
  ...
  return (
    <div className="group w-full">
      ...
      <div className={`
        ...
        ${!readOnly
          ? 'bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-700 shadow-sm hover:shadow-md hover:border-indigo-300 dark:hover:border-indigo-500 focus-within:ring-4 focus-within:ring-indigo-100 dark:focus-within:ring-indigo-900/30 focus-within:border-indigo-400'
      ...
      `}>
        <input
          type="number"
          className={`
            block w-full min-w-0 flex-1 bg-transparent border-none
            py-3 pl-4 pr-2
